                    ...
                    @foreach ($data as $key=>$row)
                        ...
                        <div class="p-6 border-t border-gray-200 md:border-l px-12">
                            ...
                            <div class="mt-3 text-sm text-gray-600 leading-7 font-semibold">
                                <button href="{{ route('contact.delete',$row->id) }}" onClick="loadDeleteModal({{$row->id}})" data-toggle="modal" data-target="#exampleModal" type="button" class="ml-12 inline-flex items-center justify-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 focus:outline-none focus:border-red-700 focus:ring focus:ring-red-200 active:bg-red-600 disabled:opacity-25 transition">
